...
<section>
		...
		<hr class="hr">
		<span class="four">휴대전화 : </span> ${vo.user_tel }<input type ="button" class="button" onclick="getShow3()" value="전화번호변경">
		...
		<hr class="hr">
		<span class="three">배송지 :</span> ${vo.user_address } <input type ="button" class="button" onclick="getShow2()" value="배송지 번경">
